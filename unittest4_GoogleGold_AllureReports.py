...
class ChromeSearch(unittest.TestCase):
    ...
    def test_search(self):
        ...
        try:
            ...
            driver.get_screenshot_as_file('Gold_page.png')
        except TimeoutException:
            print("Loading took too much time!")
...
# To run AllureReports use from Terminal:
# py.test --alluredir=C:/Users/isura/PycharmProjects/seleniumWebdriverFramework1/AllureReports ./unittest4_GoogleGold_AllureReports.py

# To generate Allure Reports in Browser to use:
# allure serve C:/Users/isura/PycharmProjects/seleniumWebdriverFramework1/AllureReports