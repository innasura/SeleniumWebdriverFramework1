...
if __name__ == '__main__':
    unittest.main(
        testRunner=HtmlTestRunner.HTMLTestRunner(output='C:/Users/isura/PycharmProjects/SeleniumWebdriverFramework1'
                                                       '/HtmlReports'))

# Run your test file from Terminal:
# python unittest4_GoogleGold_HTML_TestRunner.py
